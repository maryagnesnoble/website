...
<meta name="generated" content="2008-12-04 20:44:37 EST"/>
...
<?php $visitorlog_file = "results-advanced.visitors" ; $visitorlog_mailto = array(dan => "davison@stats.ox.ac.uk", mary => "mnoble@princeton.edu") ; 
$visitorlog_msg = "The visitor searched for '" . $_POST['regex'] . "' in " . $_POST['url'] ;
